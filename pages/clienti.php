        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                    <img alt="Brand" src="../media/logo.png" style="width: 100%; height: 100%" />
                </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="clienti.html"><i class="fa fa-group fa-fw"></i> Clienti</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header"><i class="fa fa-group fa-1x"></i> Clienti</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
?>
                                    <tr>
                                        ...
                                        <td><? echo $row["EURO_LITRO"]; ?>
                                        </td>
                                        <td><? echo $row["LITRI_100KM"]; ?>
                                        </td>
                                    </tr>
                            <?php
};
