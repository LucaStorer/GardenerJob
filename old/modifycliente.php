        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="clienti.php">
                            <i class="fa fa-group fa-fw"></i>Clienti
                        </a>
                    </li>
                    <li>
                        <a href="risorse.html">
                            <i class="fa fa-pied-piper fa-fw"></i>Risorse
                        </a>
                    </li>
                    <li>
                        <a href="prodotti.html">
                            <i class="fa fa-flask fa-fw"></i>Prodotti
                        </a>
                    </li>
                    <li>
                        <a href="interventi.html">
                            <i class="fa fa-leaf fa-fw"></i>Interventi
                        </a>
                    </li>
                    <li>
                        <a href="../pages_original/tables.html">
